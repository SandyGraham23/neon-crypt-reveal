...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "LuckyNumberLottery",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.LuckyNumberLottery__factory>;
    getContractFactory(
      name: "SimpleLottery",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.SimpleLottery__factory>;
    ...
    getContractAt(
      ...
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.LuckyNumberLottery>;
    getContractAt(
      name: "SimpleLottery",
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.SimpleLottery>;
