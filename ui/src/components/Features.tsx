...
const features = [
  ...
  },
  {
    ...
    title: "Provably Fair",
    description:
      "Smart contracts guarantee tamper-proof lottery with transparent, verifiable encryption and random selection.",
  },
  {
    icon: Sparkles,
  ...
  return (
    <section id="features" className="py-20 relative">
      <div className="container mx-auto px-4">
        ...
        >
          <h3 className="text-4xl md:text-5xl font-orbitron font-bold mb-4 neon-text">How It Works</h3>
              ...
              >
                ...
                <div className="relative bg-card border border-primary/20 rounded-lg p-6 hover:border-primary/50 transition-all h-full">
                  <motion.div
                    ...
                    className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-4 neon-border"
                  >
                    <Icon className="h-6 w-6 text-primary" />
                  </motion.div>

                  <h4 className="text-xl font-orbitron font-bold mb-3 neon-text">{feature.title}</h4>
